// Generate 6th Grade Tom Sawyer lessons with CLEAN UI template
// Based on templates/lesson-template.html structure

const fs = require('fs');

// Load data
const unitCard = JSON.parse(fs.readFileSync('book-data/tom-sawyer-complete-unit-card.json', 'utf8'));
const grammarLessons = JSON.parse(fs.readFileSync('book-data/tom-sawyer-grammar.json', 'utf8'));
const languageLessons = JSON.parse(fs.readFileSync('book-data/tom-sawyer-language.json', 'utf8'));
...
// Generate a regular lesson (non-assessment days)
function generateLesson(day) {
  ...
  // Fallback if skill topic doesn't exist for this day
  if (!skillTopic) {
  ...
  <div class="container">
    ...
    <div class="page active" data-page="1">
      <div style="text-align: center; padding: 60px 30px;">
        ...
        <div style="font-size: 1rem; color: #999;">Week ${week} • The Adventures of Tom Sawyer • 6th Grade</div>
      </div>
    </div>
    ...
    <div class="page" data-page="2">
      ...
      <p>Today we're reading <strong>${escapeHtml(chapter.title)}</strong> from <em>The Adventures of Tom Sawyer</em> by Mark Twain.</p>
      ...
      <div class="info-box">
        <p><strong>📝 Remember:</strong> As you read, think about how the characters' choices affect the story. Mark Twain often uses humor to teach lessons about human nature.</p>
      </div>
    </div>
    ...
    <div class="page" data-page="10">
      ...
      ` : ''}
      ` : `
      <p>No informational text available for this lesson.</p>
      `}
    </div>
    ...
    <div class="page" data-page="11">
      ...
      <div class="info-box">
        ...
        <p>${chapter.writingPrompt || 'Write a paragraph analyzing an important moment from today\'s chapter. What did the character learn? How did this event move the story forward?'}</p>
      </div>
      ...
      <ul>
        ...
        <li>How would you have handled the situation differently?</li>
...
// Main execution
console.log('\n🏗️  Generating 6th Grade Tom Sawyer lessons with CLEAN UI\n');
...
console.log(`\n✨ Done! Generated ${generated} lessons for 6th grade.\n`);
