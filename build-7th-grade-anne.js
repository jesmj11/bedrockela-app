// Build 7th Grade Unit 2: Anne of Green Gables
...
// Load data
const unitCard = JSON.parse(fs.readFileSync('book-data/anne-green-gables-unit-card.json', 'utf8'));
  ...
  pages.push(`
    <div class="lesson-page" data-page="1">
      <div class="page-content title-page">
        ...
        <p class="lesson-meta">Anne of Green Gables</p>
...
function buildAssessmentLesson(day) {
  ...
  pages.push(`
    <div class="lesson-page" data-page="1">
      <div class="page-content title-page">
        ...
        <p class="lesson-meta">Week ${weekNumber + 6} - Anne of Green Gables</p>
  ...
  pages.push(generateGrammarAssessment(grammarLanguage.grammar, actualDay, 7, 'Anne of Green Gables'));
  
  // PAGE 4: LANGUAGE ASSESSMENT
  pages.push(generateLanguageAssessment(grammarLanguage.language, actualDay, 7, 'Anne of Green Gables'));
  ...
  pages.push(`
    <div class="lesson-page" data-page="8">
      <div class="page-content title-page">
        ...
        <p style="font-size: 1.2rem; color: #666; margin-bottom: 25px;">You've finished your assessment for Anne of Green Gables.</p>
...
console.log(`\n🏗️  Building 7th Grade Anne of Green Gables - Days ${DAY_OFFSET + 1}-${DAY_OFFSET + lessonsToGenerate}\n`);
...
console.log(`\n🎉 Generated ${lessonsToGenerate} lessons for 7th Grade Anne of Green Gables!`);
