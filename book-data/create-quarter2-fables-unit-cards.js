...
const books = [
  {
    file: 'crow-and-pitcher-complete.txt',
    title: 'The Crow and the Pitcher',
    bookNumber: 8,
    theme: 'problem-solving story'
  },
  {
    file: 'dog-and-reflection-complete.txt',
    title: 'The Dog and His Reflection',
    bookNumber: 9,
    theme: 'relatable lesson about greed'
  },
  {
    file: 'wind-and-sun-complete.txt',
    title: 'The Wind and the Sun',
    bookNumber: 10,
    theme: 'gentle vs. force theme'
  }
];
...
console.log('Creating Quarter 2 Fable Unit Cards...\n');
...
console.log(`\n=== Summary ===`);
console.log(`✅ Created: ${created} Quarter 2 fable unit cards`);
