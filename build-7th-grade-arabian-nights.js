// Build 7th Grade Unit 1: Tales from the Arabian Nights
...
// Load data
const unitCard = JSON.parse(fs.readFileSync('book-data/arabian-nights-unit-card.json', 'utf8'));
...
function buildRegularLesson(day) {
  ...
  pages.push(`
    <div class="lesson-page" data-page="1">
      <div class="page-content title-page">
        ...
        <p class="lesson-meta">Tales from the Arabian Nights</p>
  ...
  return buildFullHTML(day, pages, false);
}
...
// Generate lessons
const lessonsToGenerate = process.argv[2] ? parseInt(process.argv[2]) : 4;
...
console.log(`\n🎉 Generated ${lessonsToGenerate} lessons for 7th Grade Arabian Nights!`);
console.log(`📂 Location: curriculum/grade7/`);
console.log(`\n📋 Next: Build assessment days (5, 10, 15, 20, 25, 30)`);
