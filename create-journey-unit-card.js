#!/usr/bin/env node
/**
 * CREATE JOURNEY TO THE CENTER OF THE EARTH UNIT CARD
 * 
 * Parses the three Journey to the Center of the Earth source files and creates a complete
...
// Input files
const SOURCE_DIR = '/Users/mushu/Desktop/BedrockELA/6th ELA/journey';
const STORY_FILE = path.join(SOURCE_DIR, 'journey-complete.txt');
const QUESTIONS_FILE = path.join(SOURCE_DIR, 'journey-questions.txt');
const VOCAB_FILE = path.join(SOURCE_DIR, 'journey-vocab.txt');

// Output file
const OUTPUT_FILE = './book-data/journey-unit-card.json';

console.log('📚 Creating Journey to the Center of the Earth Unit Card...\n');
...
const unitCard = {
    unitInfo: {
        ...
        originalAuthor: 'Based on the novel by Jules Verne (1864)',
        adaptation: 'Adapted for 6th Grade Readers',
        totalChapters: 24,
        gradeLevel: '6th Grade',
        compatibleGrades: ['6th', '7th', '8th'],
        genre: 'Science Fiction / Adventure',
        themes: ['Exploration', 'Science', 'Discovery', 'Courage', 'Perseverance', 'Wonder'],
        totalLessons: 24,
        vocabularyWords: 96,
        totalQuestions: 72,
        estimatedWeeks: 5,
