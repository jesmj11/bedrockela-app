#!/usr/bin/env node
/**
 * CREATE ROBIN HOOD UNIT CARD
 * 
 * Parses the three Robin Hood source files and creates a complete
...
// Input files
const SOURCE_DIR = '/Users/mushu/Desktop/BedrockELA/6th ELA/Robin Hood';
const STORY_FILE = path.join(SOURCE_DIR, 'robin-hood-complete.txt');
const QUESTIONS_FILE = path.join(SOURCE_DIR, 'robin-hood-questions.txt');
const VOCAB_FILE = path.join(SOURCE_DIR, 'robin-hood-vocab.txt');

// Output file
const OUTPUT_FILE = './book-data/robin-hood-unit-card.json';

console.log('📚 Creating Robin Hood Unit Card...\n');
...
const unitCard = {
    unitInfo: {
        ...
        originalAuthor: 'Based on legends retold by Howard Pyle (1883)',
        adaptation: 'Adapted for 6th Grade Readers',
        totalChapters: 24,
        gradeLevel: '6th Grade',
        compatibleGrades: ['6th', '7th', '8th'],
        genre: 'Historical Fiction / Legend',
