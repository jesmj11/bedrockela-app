#!/usr/bin/env node
/**
 * MERGE JOURNEY TO THE CENTER OF THE EARTH DATA INTO COMPLETE UNIT CARD
 * 
...
console.log('📦 Merging Journey to the Center of the Earth data into complete unit card...\n');

// Load both files
const unitCard = JSON.parse(fs.readFileSync('./book-data/journey-unit-card.json', 'utf-8'));
const curriculum = JSON.parse(fs.readFileSync('./book-data/journey-curriculum-complete.json', 'utf-8'));
...
fs.writeFileSync('./book-data/journey-complete-unit-card.json', JSON.stringify(completeUnitCard, null, 2), 'utf-8');

console.log('✅ Complete unit card created!');
console.log(`📄 Saved to: book-data/journey-complete-unit-card.json\n`);
