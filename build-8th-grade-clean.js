...
// 5 books for 8th grade (150 days complete, 30 remaining)
const books = [
  { file: 'frankenstein-complete-unit-card.json', dayStart: 1, dayEnd: 30, emoji: '⚡', theme: 'Gothic Horror' },
  { file: 'jekyll-hyde-complete-unit-card.json', dayStart: 31, dayEnd: 60, emoji: '🎭', theme: 'Duality' },
  { file: 'dorian-gray-complete-unit-card.json', dayStart: 61, dayEnd: 90, emoji: '🖼️', theme: 'Morality' },
  { file: 'beowulf-complete-unit-card.json', dayStart: 91, dayEnd: 120, emoji: '⚔️', theme: 'Epic Poetry' },
  { file: 'sherlock-complete-unit-card.json', dayStart: 121, dayEnd: 150, emoji: '🔍', theme: 'Mystery' }
  // NOTE: Days 151-180 (Hunchback) need proper unit card with chapters array
];
...
console.log('🏗️  Building all 180 8th grade lessons...\n');
...
books.forEach(book => {
  ...
  for (let day = book.dayStart; day <= book.dayEnd; day++) {
    ...
    console.log(`  ✅ Day ${day} - ${chapter.chapter}`);
  }
...
console.log('📂 Files saved to: curriculum/grade8/');
